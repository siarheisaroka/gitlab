...
# instance template
resource "google_compute_instance_template" "runner3" {
  name        = "runner-template3"
...
resource "google_compute_region_instance_group_manager" "runner3" {
  project            = var.project
  name               = "runner3"
  base_instance_name = "runner3"
  target_size        = 1
  region             = "us-central1"
  ...
  version {
    instance_template = google_compute_instance_template.runner3.id
  }
